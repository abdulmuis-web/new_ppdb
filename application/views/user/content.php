...
$tutup = $jadwal['tanggal'];
?>

<script>
var tutup = <?php echo json_encode($tutup); ?>;
var countDownDate = new Date(tutup).getTime();
var x = setInterval(function() {
  ...
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("carasingkat").innerHTML = "Ditutup";
  } 
}, 1000);
</script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> <p id="tanggal" style="display:none"><?php echo $tutup; ?></p>
        Dashboard
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Kuota Minimal Zonasi</span>
              <span class="info-box-number"><?php foreach ($kuota as $kuota); echo ceil($kuota['kuota']*90/100); ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Kuota Sekolah</span>
              <span class="info-box-number"><?= $kuota['kuota'];?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" id="carasingkat"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
