...
<html>
    <head>
        ...
        <link rel="icon" href="<?php echo base_url();?>assets/images/kalsel.gif">
        ...
        <link
            rel="stylesheet"
            href="<?= base_url();?>assets/plugins/iCheck/square/blue.css">
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                <p class="text-center"><img width="30px" src="<?php echo base_url();?>assets/images/kalsel.gif" alt=""></p>
                <?php if ($this->session->flashdata('message')) {
                  echo $this->session->flashdata('message');
                }
                 ?>
                <form action="<?= base_url('login/superuser');?>" method="post">
